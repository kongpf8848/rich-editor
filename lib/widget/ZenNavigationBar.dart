...
// Source code: https://github.com/flutter/flutter/blob/master/packages/flutter/lib/src/cupertino/nav_bar.dart
...
const double _kNavBarPersistentHeight = 60;
...
const double _kNavBarEdgePadding = 0;
...
class ZenNavigationBar extends StatefulWidget
    implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const ZenNavigationBar(
      {Key? key,
      this.leading,
      ...
      this.height = _kNavBarPersistentHeight})
  ...
  @override
  State<ZenNavigationBar> createState() => _CupertinoNavigationBarState();
}
...
class _CupertinoNavigationBarState extends State<ZenNavigationBar> {
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget paddedToolbar = NavigationToolbar(
      ...
      centerMiddle: true,
      middleSpacing: leading != null ? 6.0 : 0.0,
    );
